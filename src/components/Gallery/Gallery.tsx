        ...
        >
          <div className="flex justify-center">
            ...
            >
              ...
              <span className="relative">گالری</span>
            </button>
          </div>
          <h2
            className={cn(
          ...
          >
            پروژه های مورد انتظار ما
          </h2>
          <p className="mt-5 text-center text-lg text-zinc-500">
            معمولا بهترین معلم ما چشمان ما هستند پس با دیدن نمونه پروژه ها مسیر خود را بهتر بیابید
          </p>
        </motion.div>
          ...
          <div className="mt-20 flex flex-col items-center justify-center">
            <div className="mx-auto flex h-[90px] max-w-[480px] items-center justify-center gap-4 rounded-3xl border-2 border-dashed px-6">
              <p className="text-lg opacity-60">
                بیشتر سایت های ما با نکست جی اس طراحی شده است که اط لحاظ سئو توصیه شده سایت گوگل است و بزرگترین شرکت های دنیا از این پلتفرم جهت طراحی سایت خود استفاده میکنند
              </p>
            </div>
            <div className="mx-auto my-10  flex flex-col items-center justify-center">
              <div className="flex items-center justify-end gap-2 text-center text-lg md:text-2xl lg:text-3xl">
                <p className='py-6'>طراحی سایت کامپوننت محور سریع و ارزان و با کیفیت</p>
              ...
              <p className="text-center text-md md:text-xl lg:text-2xl">
                بساز و  <span className="text-primary font-bold">بفروش</span>... و
                بساز و  <span className="text-primary font-bold">مشتریانت رو گسترش بده</span>...
              </p>
            </div>
            ...
            <WrapButtonDemo className="mt-10" href="/sign-up">
